...
vim.keymap.set("n", "<C-s>", "<Cmd>write<CR><Esc>", { silent = true, noremap = true })
...
vim.keymap.set('n', '<leader>ss',
  function()
    ...
    if vim.v.this_session == '' or vim.v.this_session == nil then
...
vim.keymap.set('n', '<leader>sc', ":let v:this_session = '' <CR>", { desc = 'Clear session' })
